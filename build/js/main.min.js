  ...
  if (calcBlock) {
    ...
    calcBlock.addEventListener('click', function (event) {
      ...
      if (target.dataset.submit === 'further01') {
        ...
        var dataBuildingType = calcBlock.querySelector('input[name="building-age"]:checked').value; // const dataWorkType = calcBlock.querySelectorAll('input[name="type-of-work"]:checked');
