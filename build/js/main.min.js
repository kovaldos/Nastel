...
/* harmony import */ var _modules_calc_app__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calc-app */ "./js/modules/calc-app.js");
/* harmony import */ var _modules_test_webp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/test-webp */ "./js/modules/test-webp.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_3__["initFormValidate"])(); // initCalculatorApp();

    Object(_modules_calc_app__WEBPACK_IMPORTED_MODULE_4__["calcApp"])();
    Object(_modules_test_webp__WEBPACK_IMPORTED_MODULE_5__["initTestWebp"])();
  });
}); // ---------------------------------
  ...
  if (calcBlock) {
    ...
    calcBlock.addEventListener('click', function (event) {
      ...
      if (target.dataset.submit === 'further01') {
        ...
        var dataBuildingType = calcBlock.querySelector('input[name="building-age"]:checked').value;
        var dataWorkType = calcBlock.querySelectorAll('input[name="type-of-work"]:checked');

        var getDataWorkTypeValue = function getDataWorkTypeValue() {
          var result = [];
          dataWorkType.forEach(function (item) {
