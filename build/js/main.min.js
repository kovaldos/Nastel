...
/* harmony import */ var _modules_calc_app__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/calc-app */ "./js/modules/calc-app.js");
/* harmony import */ var _modules_test_webp__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/test-webp */ "./js/modules/test-webp.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_2__["initFormValidate"])(); // initCalculatorApp();

    Object(_modules_calc_app__WEBPACK_IMPORTED_MODULE_3__["calcApp"])();
    Object(_modules_test_webp__WEBPACK_IMPORTED_MODULE_4__["initTestWebp"])();
  });
}); // ---------------------------------
...
/*!********************************!*\
  !*** ./js/modules/calc-app.js ***!
  \********************************/
/*! exports provided: calcApp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calcApp", function() { return calcApp; });
/* eslint-disable no-console */
// Расчет стоимости работ -- Начало --
// Calculation of the cost of work -- Start --
var calcApp = function calcApp() {
  var calcBlock = document.querySelector('.calculator');

  if (calcBlock) {
    // const data = [];
    var screen01 = calcBlock.querySelector('[data-screen="screen01"]');
    var screen0201 = calcBlock.querySelector('[data-screen="screen0201"]');
    var screen0202 = calcBlock.querySelector('[data-screen="screen0202"]');
    var screen0203 = calcBlock.querySelector('[data-screen="screen0203"]');
    var screen0204 = calcBlock.querySelector('[data-screen="screen0204"]');
    var screen0301 = calcBlock.querySelector('[data-screen="screen0301"]');
    var screen0302 = calcBlock.querySelector('[data-screen="screen0302"]');
    var screen0303 = calcBlock.querySelector('[data-screen="screen0303"]');
    var screen04 = calcBlock.querySelector('[data-screen="screen04"]');
    calcBlock.addEventListener('click', function (event) {
      ...
      if (target.dataset.submit === 'further01') {
        var dataLength = calcBlock.querySelector('[data-size="length"] input');
        var dataWidth = calcBlock.querySelector('[data-size="width"] input');
        var dataBuildingType = calcBlock.querySelector('input[name="building-type"]:checked').id; // const dataWorkType = calcBlock.querySelectorAll('input[name="type-of-work"]:checked');
...
var calcFormHelpValidationSuccessCallback = function calcFormHelpValidationSuccessCallback(e) {
  e.preventDefault(); // В данном колбеке бэкендер будет писать запрос на отправку формы на сервер и обрабатывать возможные ошибки при отправке

  var calcFormHelp = document.getElementById('calcFormHelp');
  var formData = new FormData(calcFormHelp);
...
var calcFormHelpValidationErrorCallback = function calcFormHelpValidationErrorCallback(e) {
  e.preventDefault(); // eslint-disable-next-line no-console
...
var callbacks = {
  ...
  customExample: {
    ...
    calcFormHelpValidationSuccessCallback: calcFormHelpValidationSuccessCallback,
    validationErrorCallback: customExampleValidationErrorCallback
  },
  calcFormCallback: {
    validationSuccessCallback: calcFormHelpValidationSuccessCallback,
    validationErrorCallback: calcFormHelpValidationErrorCallback
  }
};
...
/*!*********************************!*\
  !*** ./js/modules/test-webp.js ***!
  \*********************************/
/*! exports provided: initTestWebp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTestWebp", function() { return initTestWebp; });
// test for browser webp support -- Start --
var initTestWebp = function initTestWebp() {
